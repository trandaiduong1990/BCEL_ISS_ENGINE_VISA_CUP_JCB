...
public class HSMMsg  {
  ...
  public byte[] pack()
  {
    ...
    System.out.println("totallength1="+totalLength);
    ...
    System.out.println("accumulateLength="+accumulateLength+" "+NumberUtil.hexString(b));
  ...
  {
	  System.out.println("***SetContent**"+fieldname+"  "+NumberUtil.hexString(content));
    ...
    if (field instanceof VariableLengthField)
    {
		System.out.println("in VariableLengthField");
      VariableLengthField vf = (VariableLengthField)field;
      vf.setContent(content);
      fields.put(fieldname,vf);
    }
