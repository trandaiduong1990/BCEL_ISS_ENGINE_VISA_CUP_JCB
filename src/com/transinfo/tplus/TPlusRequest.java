...
public class TPlusRequest extends java.lang.Object implements TPRunnable
{
	...
	public void run()
	{
		...
		finally
		{
			...
			/*try
			{
				System.out.println("************ SENDING DATA TO MONITOR *****************");
				DataSender ds = new DataSender();
				ds.initService("");
				ds.createData(objISOParser,objISOParser.isParse(),boolReqError,strReqExp);
			}
			catch(Exception exp){ System.out.println("Error while sending the tranx to monitor");}
			 */
