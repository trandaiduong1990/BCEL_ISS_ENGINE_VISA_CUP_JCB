...
public class RefundReversalRequest extends RequestBaseHandler {
	...
	public IParser execute(IParser objISO) throws TPlusException {
		...
		try {
			...
			if((objTranxInfo = objTransactionDB.recordExistsReversal(objISO)) != null){
				...
				objTransactionDB.updateRefundReversalAndVoid(objISO,orgTraceNo,objCardCashPurseDataBean.getAccountId(), amount);
