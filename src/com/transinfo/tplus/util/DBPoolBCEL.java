...
public class DBPoolBCEL  implements DBConnection
{
	...
	public DBPoolBCEL()
	{
		...
		System.out.println(TPlusConfig.CUPSMSJDBCURL+"   "+TPlusConfig.CUPSMSDBUserID+"  "+TPlusConfig.CUPSMSDBPassword);
		ds.setUrl(TPlusConfig.CUPSMSJDBCURL);
		ds.setUsername(TPlusConfig.CUPSMSDBUserID);
		ds.setPassword(TPlusConfig.CUPSMSDBPassword);
		ds.setInitialSize(Integer.parseInt(TPlusConfig.CUPSMSDBInitSize));
		ds.setMaxActive(Integer.parseInt(TPlusConfig.CUPSMSDBMaxActive));
		ds.setMaxWait(Integer.parseInt(TPlusConfig.CUPSMSDBMaxWait));
