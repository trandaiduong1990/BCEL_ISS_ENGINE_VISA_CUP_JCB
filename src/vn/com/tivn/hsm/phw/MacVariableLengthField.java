...
public class MacVariableLengthField
{
  protected byte [] content;
  protected byte [] lengthPrefix;
  public MacVariableLengthField()
  {
  }
  public void  setContent(byte[] c)
  {
    ...
    for (int j = 0; j<prefixLength-1;j++)
    {
      ...
      System.out.println("lengthPrefix[1]"+ (char)lengthPrefix[1]);
      System.out.println("lengthPrefix[0]"+ (char)lengthPrefix[0]);
